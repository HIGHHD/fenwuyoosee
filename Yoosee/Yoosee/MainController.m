...
-(void)initComponent{
    //dwApContactID只在AppDelegate中设置过一回
    //contact
...
//        [messageController release];
        TestInterfaceViewController *testInter = [[TestInterfaceViewController alloc] init];
        controller2 = [[AutoNavigation alloc] initWithRootViewController:testInter];
        [testInter release];
    }
    ...
    {
        [self setViewControllers:@[controller1,controller3]];
        [controller1 release];
        [controller3 release];
    }
